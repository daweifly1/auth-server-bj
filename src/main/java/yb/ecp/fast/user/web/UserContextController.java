...
public class UserContextController extends BasicController {
   ...
   @Autowired
   UserContextService ALLATORIxDEMO;
   ...
   public ActionResult authCode(@RequestHeader("x-user-id") String userId) {
      return this.actionResult(this.ALLATORIxDEMO.getAuthCodes(userId));
   }
   ...
   public ActionResult session(@RequestBody SessionDataVO sessionDataVO) {
      this.ALLATORIxDEMO.setSession(sessionDataVO.getUserId(), sessionDataVO.getData(), sessionDataVO.getCodes(), (String)null);
   ...
   public ActionResult checkAuthCode(@RequestParam("userId") String userId, @RequestParam("authCode") int authCode) {
      return this.actionResult(this.ALLATORIxDEMO.checkAuthCode(userId, Integer.valueOf(authCode)));
   }
   ...
   public ActionResult session(@RequestHeader("x-user-id") String userId) {
      ...
      Object a1 = this.ALLATORIxDEMO.getSessionData(userId);
      Integer[] a2 = this.ALLATORIxDEMO.getAuthCodes(userId);
      a.setCodes(a2);
      a.setData(a1);
   ...
   public ActionResult getWorkspaceId(@RequestParam("userId") String userId) {
      return this.actionResult(this.ALLATORIxDEMO.getWorkspaceId(userId));
   }
   ...
   public ActionResult sessionData(@RequestHeader("x-user-id") String userId) {
      return this.actionResult(this.ALLATORIxDEMO.getSessionData(userId));
   }
}
